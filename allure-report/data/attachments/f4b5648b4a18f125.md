...
Received: false
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\dropdown.spec.js:59:25
```
...
- table:
  - rowgroup:
    - row "Name Memory (MB) CPU (%) Network (Mbps) Disk (MB/s)":
      - cell "Name"
      - cell "Memory (MB)"
      - cell "CPU (%)"
      - cell "Network (Mbps)"
      - cell "Disk (MB/s)"
  - rowgroup:
    - row "Chrome 70.8 MB 3.8% 1.8 Mbps 0.07 MB/s":
      - cell "Chrome"
      - cell "70.8 MB"
      - cell "3.8%"
      - cell "1.8 Mbps"
      - cell "0.07 MB/s"
    - row "Firefox 98.3 MB 8.5% 2.0 Mbps 0.28 MB/s":
      - cell "Firefox"
      - cell "98.3 MB"
      - cell "8.5%"
      - cell "2.0 Mbps"
      - cell "0.28 MB/s"
    - row "Internet Explorer 86.2 MB 8.5% 3.9 Mbps 0.51 MB/s":
      - cell "Internet Explorer"
      - cell "86.2 MB"
      - cell "8.5%"
      - cell "3.9 Mbps"
      - cell "0.51 MB/s"
    - row "System 79.3 MB 9.6% 5.8 Mbps 0.27 MB/s":
      - cell "System"
      - cell "79.3 MB"
      - cell "9.6%"
      - cell "5.8 Mbps"
...
```ts
  ...
  51 |         let value = await op.textContent()
  52 |         if(value.includes('South Korea'))
  53 |         {
  54 |             status = true;
  55 |             break;
  56 |         }
