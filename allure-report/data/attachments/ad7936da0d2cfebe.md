...
Call log:
  ...
  - waiting for locator('#demo')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\alerts.spec.js:36:41
```
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) CPU (%) Memory (MB) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Firefox 0.27 MB/s 5.6% 50.8 MB 2.1 Mbps":
      - cell "Firefox"
      - cell "0.27 MB/s"
      - cell "5.6%"
      - cell "50.8 MB"
      - cell "2.1 Mbps"
    - row "Chrome 0.95 MB/s 7.3% 88.0 MB 3.0 Mbps":
      - cell "Chrome"
      - cell "0.95 MB/s"
      - cell "7.3%"
      - cell "88.0 MB"
      - cell "3.0 Mbps"
    - row "Internet Explorer 0.40 MB/s 8.4% 36.0 MB 7.6 Mbps":
      - cell "Internet Explorer"
      - cell "0.40 MB/s"
      - cell "8.4%"
      - cell "36.0 MB"
      - cell "7.6 Mbps"
    - row "System 0.46 MB/s 8.8% 57.4 MB 8.4 Mbps":
      - cell "System"
      - cell "0.46 MB/s"
      - cell "8.8%"
      - cell "57.4 MB"
...
```ts
  ...
  31 |         expect(dialog.type()).toContain('confirm')
  32 |         expect(dialog.message()).toContain('Press a button!')
  33 |         await dialog.accept();
  34 |     })
  35 |     await page.click('//button[@onclick="myFunctionConfirm()"]');
> 36 |     await expect(page.locator('#demo')).toHaveText('You pressed OK!');
     |                                         ^ Error: expect(locator).toHaveText(expected)
