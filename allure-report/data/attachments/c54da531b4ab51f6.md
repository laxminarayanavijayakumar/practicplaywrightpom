...
- Name: date picker 2
- Location: C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\datepicker.spec.js:41:1
...
Call log:
  - waiting for locator('txtDate')

    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\datepicker.spec.js:49:16
```
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Network (Mbps) Memory (MB) CPU (%)":
      ...
      - cell "CPU (%)"
  - rowgroup:
    - row "Internet Explorer 0.00 MB/s 7.3 Mbps 59.2 MB 9.8%":
      - cell "Internet Explorer"
      - cell "0.00 MB/s"
      - cell "7.3 Mbps"
      - cell "59.2 MB"
      - cell "9.8%"
    - row "Chrome 0.26 MB/s 1.4 Mbps 86.6 MB 3.3%":
      - cell "Chrome"
      - cell "0.26 MB/s"
      - cell "1.4 Mbps"
      - cell "86.6 MB"
      - cell "3.3%"
    - row "System 0.72 MB/s 2.5 Mbps 74.7 MB 2.1%":
      - cell "System"
      - cell "0.72 MB/s"
      - cell "2.5 Mbps"
      - cell "74.7 MB"
      - cell "2.1%"
    - row "Firefox 0.26 MB/s 8.8 Mbps 75.8 MB 3.0%":
      - cell "Firefox"
      - cell "0.26 MB/s"
      - cell "8.8 Mbps"
      - cell "75.8 MB"
...
```ts
  ...
  39 | })
  40 |
  41 | test('date picker 2', async ({page}) => {
  42 |
