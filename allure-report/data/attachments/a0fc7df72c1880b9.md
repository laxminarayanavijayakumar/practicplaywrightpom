...
- table:
  - rowgroup:
    - row "Name Memory (MB) Disk (MB/s) CPU (%) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Chrome 92.3 MB 0.40 MB/s 1.0% 4.8 Mbps":
      - cell "Chrome"
      - cell "92.3 MB"
      - cell "0.40 MB/s"
      - cell "1.0%"
      - cell "4.8 Mbps"
    - row "System 74.7 MB 0.74 MB/s 6.0% 2.8 Mbps":
      - cell "System"
      - cell "74.7 MB"
      - cell "0.74 MB/s"
      - cell "6.0%"
      - cell "2.8 Mbps"
    - row "Firefox 41.1 MB 0.09 MB/s 2.1% 2.2 Mbps":
      - cell "Firefox"
      - cell "41.1 MB"
      - cell "0.09 MB/s"
      - cell "2.1%"
      - cell "2.2 Mbps"
    - row "Internet Explorer 76.2 MB 0.77 MB/s 2.2% 9.5 Mbps":
...
> 14 |             await page.selectOption("#country", data);
  ...
  22 | })
  23 |
  24 | test('handle dropdown' , async ({page}) => {
  25 |
