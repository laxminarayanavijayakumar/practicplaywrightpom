...
Call log:
  - waiting for locator('//a[@class="btn btn-success btn-lg"]')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\screenshot2.spec.js:24:68
```
...
```ts
  ...
  19 |             //     await products.click()
  20 |             //     break;
  21 |             // }
  22 |         }
  23 |
> 24 |         await page.locator('//a[@class="btn btn-success btn-lg"]').click();
     |                                                                    ^ Error: locator.click: Test timeout of 30000ms exceeded.
