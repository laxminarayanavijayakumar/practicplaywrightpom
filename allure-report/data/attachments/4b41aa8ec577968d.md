...
Call log:
  - waiting for locator(':scope')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\screenshot2.spec.js:17:40
```
...
```ts
  ...
  15 |
  16 |         for(const products of productlists){
> 17 |             console.log(await products.textContent());
     |                                        ^ Error: elementHandle.textContent: Execution context was destroyed, most likely because of a navigation
  18 |             if ('Iphone 6 32gb' === await products.textContent()) {
