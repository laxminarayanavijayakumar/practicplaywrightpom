...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Network (Mbps) CPU (%) Memory (MB)":
      ...
      - cell "Memory (MB)"
  - rowgroup:
    - row "Firefox 0.01 MB/s 5.4 Mbps 6.7% 63.0 MB":
      - cell "Firefox"
      - cell "0.01 MB/s"
      - cell "5.4 Mbps"
      - cell "6.7%"
      - cell "63.0 MB"
    - row "Internet Explorer 0.35 MB/s 7.7 Mbps 9.2% 63.1 MB":
      - cell "Internet Explorer"
      - cell "0.35 MB/s"
      - cell "7.7 Mbps"
      - cell "9.2%"
      - cell "63.1 MB"
    - row "System 0.70 MB/s 9.3 Mbps 6.6% 74.7 MB":
      - cell "System"
      - cell "0.70 MB/s"
      - cell "9.3 Mbps"
      - cell "6.6%"
      - cell "74.7 MB"
    - row "Chrome 0.35 MB/s 7.1 Mbps 5.7% 45.8 MB":
      - cell "Chrome"
      - cell "0.35 MB/s"
      - cell "7.1 Mbps"
      - cell "5.7%"
...
```ts
  ...
  13 |         // await page.waitForTimeout(40000);
