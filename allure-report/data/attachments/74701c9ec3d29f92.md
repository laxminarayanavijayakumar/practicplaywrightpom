...
Call log:
  ...
  - attempting select option action
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\dropdown.spec.js:15:24
```
...
- table:
  - rowgroup:
    - row "Name Memory (MB) Network (Mbps) CPU (%) Disk (MB/s)":
      - cell "Name"
      - cell "Memory (MB)"
      - cell "Network (Mbps)"
      - cell "CPU (%)"
      - cell "Disk (MB/s)"
  - rowgroup:
    - row "System 52.4 MB 1.8 Mbps 2.8% 0.72 MB/s":
      - cell "System"
      - cell "52.4 MB"
      - cell "1.8 Mbps"
      - cell "2.8%"
      - cell "0.72 MB/s"
    - row "Internet Explorer 91.1 MB 9.3 Mbps 6.1% 0.39 MB/s":
      - cell "Internet Explorer"
      - cell "91.1 MB"
      - cell "9.3 Mbps"
      - cell "6.1%"
      - cell "0.39 MB/s"
    - row "Firefox 90.3 MB 9.1 Mbps 5.1% 0.12 MB/s":
      - cell "Firefox"
      - cell "90.3 MB"
      - cell "9.1 Mbps"
      - cell "5.1%"
      - cell "0.12 MB/s"
    - row "Chrome 88.0 MB 8.0 Mbps 2.6% 1.00 MB/s":
      - cell "Chrome"
      - cell "88.0 MB"
      - cell "8.0 Mbps"
      - cell "2.6%"
...
```ts
  ...
  14 |         {
> 15 |             await page.selectOption("#country", data);
     |                        ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
  16 |             break;
  17 |         }
  18 |
