...
- table:
  - rowgroup:
    - row "Name Network (Mbps) Disk (MB/s) Memory (MB) CPU (%)":
      ...
      - cell "CPU (%)"
  - rowgroup:
    - row "Chrome 5.3 Mbps 0.72 MB/s 83.9 MB 9.3%":
      - cell "Chrome"
      - cell "5.3 Mbps"
      - cell "0.72 MB/s"
      - cell "83.9 MB"
      - cell "9.3%"
    - row "Internet Explorer 4.3 Mbps 0.43 MB/s 70.3 MB 4.4%":
      - cell "Internet Explorer"
      - cell "4.3 Mbps"
      - cell "0.43 MB/s"
      - cell "70.3 MB"
      - cell "4.4%"
    - row "Firefox 5.8 Mbps 0.88 MB/s 57.1 MB 6.9%":
      - cell "Firefox"
      - cell "5.8 Mbps"
      - cell "0.88 MB/s"
      - cell "57.1 MB"
      - cell "6.9%"
    - row "System 7.9 Mbps 0.15 MB/s 44.1 MB 6.8%":
      - cell "System"
      - cell "7.9 Mbps"
      - cell "0.15 MB/s"
      - cell "44.1 MB"
