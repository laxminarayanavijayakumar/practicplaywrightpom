...
- table:
  - rowgroup:
    - row "Name Network (Mbps) Disk (MB/s) Memory (MB) CPU (%)":
      ...
      - cell "CPU (%)"
  - rowgroup:
    - row "System 1.8 Mbps 0.11 MB/s 83.1 MB 9.0%":
      - cell "System"
      - cell "1.8 Mbps"
      - cell "0.11 MB/s"
      - cell "83.1 MB"
      - cell "9.0%"
    - row "Chrome 10.0 Mbps 0.88 MB/s 62.5 MB 2.3%":
      - cell "Chrome"
      - cell "10.0 Mbps"
      - cell "0.88 MB/s"
      - cell "62.5 MB"
      - cell "2.3%"
    - row "Internet Explorer 8.9 Mbps 0.72 MB/s 95.9 MB 7.6%":
      - cell "Internet Explorer"
      - cell "8.9 Mbps"
      - cell "0.72 MB/s"
      - cell "95.9 MB"
      - cell "7.6%"
    - row "Firefox 8.8 Mbps 0.50 MB/s 69.8 MB 5.9%":
      - cell "Firefox"
      - cell "8.8 Mbps"
      - cell "0.50 MB/s"
      - cell "69.8 MB"
...
```ts
  ...
  33 |         expect(dialog.type()).toContain('confirm')
  34 |         expect(dialog.message()).toContain('Press a button!')
