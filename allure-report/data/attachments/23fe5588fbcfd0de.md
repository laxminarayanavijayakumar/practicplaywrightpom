...
```
Error: locator.setInputFiles: Error: File input does not support directories, pass individual files instead
Call log:
  - waiting for locator('#singleFileInput')
    - locator resolved to <input type="file" id="singleFileInput"/>

    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\uploadfiles.spec.js:10:5
```
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Memory (MB) CPU (%) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "System 0.68 MB/s 70.7 MB 8.9% 4.8 Mbps":
      - cell "System"
      - cell "0.68 MB/s"
      - cell "70.7 MB"
      - cell "8.9%"
      - cell "4.8 Mbps"
    - row "Chrome 0.51 MB/s 56.7 MB 4.3% 3.2 Mbps":
      - cell "Chrome"
      - cell "0.51 MB/s"
      - cell "56.7 MB"
      - cell "4.3%"
      - cell "3.2 Mbps"
    - row "Internet Explorer 0.39 MB/s 60.1 MB 2.0% 1.3 Mbps":
      - cell "Internet Explorer"
      - cell "0.39 MB/s"
      - cell "60.1 MB"
      - cell "2.0%"
      - cell "1.3 Mbps"
    - row "Firefox 0.97 MB/s 75.3 MB 5.0% 1.1 Mbps":
      - cell "Firefox"
      - cell "0.97 MB/s"
      - cell "75.3 MB"
      - cell "5.0%"
...
```ts
   ...
   8 |     await page.click('//input[@id="singleFileInput"]')
   9 |
> 10 |     await page.locator('#singleFileInput').setInputFiles('C:/Users/HARIKATHIK V/Desktop/resume/testing resume')
     |     ^ Error: locator.setInputFiles: Error: File input does not support directories, pass individual files instead
  11 |
