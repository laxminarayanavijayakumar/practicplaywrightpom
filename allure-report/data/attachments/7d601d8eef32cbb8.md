...
Call log:
  - waiting for locator(':scope')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\screenshot2.spec.js:19:52
```
...
```ts
  ...
  16 |             
  17 |             console.log(await products.textContent());
  18 |             await page.waitForTimeout(5000);
> 19 |             if ('Iphone 6 32gb' === await products.textContent()) {
     |                                                    ^ Error: elementHandle.textContent: Execution context was destroyed, most likely because of a navigation
