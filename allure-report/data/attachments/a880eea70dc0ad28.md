...
- Name: launch store
- Location: C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\launchstore.spec.js:3:1
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\launchstore.spec.js:10:24
```
...
```ts
   ...
   2 |
   3 | test ('launch store' , async({page})=>{
   4 |
   ...
   9 |
> 10 |     await expect(page).toHaveTitle('STOR')
     |                        ^ Error: Timed out 5000ms waiting for expect(locator).toHaveTitle(expected)
  11 |
  12 |     const pageUrl = page.url()
  13 |     console.log('page url :',pageUrl)
  14 |
