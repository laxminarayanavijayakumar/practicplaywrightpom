...
Call log:
  - waiting for locator('#singleFileInput')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\uploadfiles.spec.js:8:44
```
...
- table:
  - rowgroup:
    - row "Name CPU (%) Disk (MB/s) Network (Mbps) Memory (MB)":
      ...
      - cell "Memory (MB)"
  - rowgroup:
    - row "Chrome 7.4% 0.32 MB/s 3.8 Mbps 81.0 MB":
      - cell "Chrome"
      - cell "7.4%"
      - cell "0.32 MB/s"
      - cell "3.8 Mbps"
      - cell "81.0 MB"
    - row "System 0.4% 0.42 MB/s 3.9 Mbps 93.6 MB":
      - cell "System"
      - cell "0.4%"
      - cell "0.42 MB/s"
      - cell "3.9 Mbps"
      - cell "93.6 MB"
    - row "Internet Explorer 7.3% 0.46 MB/s 2.7 Mbps 72.6 MB":
      - cell "Internet Explorer"
      - cell "7.3%"
      - cell "0.46 MB/s"
      - cell "2.7 Mbps"
      - cell "72.6 MB"
    - row "Firefox 0.8% 0.27 MB/s 1.3 Mbps 61.4 MB":
      - cell "Firefox"
      - cell "0.8%"
      - cell "0.27 MB/s"
      - cell "1.3 Mbps"
...
>  8 |     await page.locator('#singleFileInput').check()
     |                                            ^ Error: locator.check: Error: Not a checkbox or radio button
   9 |
