...
Call log:
  ...
  - attempting select option action
    ...
    - retrying select option action
      - waiting 100ms
    21 × waiting for element to be visible and enabled
       - did not find some options
     - retrying select option action
       - waiting 500ms

    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\dropdown.spec.js:70:24
```
...
- table:
  - rowgroup:
    - row "Name CPU (%) Memory (MB) Disk (MB/s) Network (Mbps)":
      - cell "Name"
      - cell "CPU (%)"
      - cell "Memory (MB)"
      - cell "Disk (MB/s)"
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Firefox 5.8% 84.4 MB 0.98 MB/s 1.0 Mbps":
      - cell "Firefox"
      - cell "5.8%"
      - cell "84.4 MB"
      - cell "0.98 MB/s"
      - cell "1.0 Mbps"
    - row "System 9.1% 41.4 MB 0.68 MB/s 7.9 Mbps":
      - cell "System"
      - cell "9.1%"
      - cell "41.4 MB"
      - cell "0.68 MB/s"
      - cell "7.9 Mbps"
    - row "Chrome 5.0% 69.8 MB 0.75 MB/s 1.1 Mbps":
      - cell "Chrome"
      - cell "5.0%"
      - cell "69.8 MB"
      - cell "0.75 MB/s"
      - cell "1.1 Mbps"
    - row "Internet Explorer 4.8% 34.6 MB 0.58 MB/s 1.0 Mbps":
...
> 70 |             await page.selectOption('#country', val);
     |                        ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
  71 |             break;
  72 |         }
  73 |         
