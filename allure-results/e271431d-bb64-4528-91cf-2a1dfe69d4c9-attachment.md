...
Call log:
  ...
  - attempting select option action
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\dropdown.spec.js:71:24
```
...
- table:
  - rowgroup:
    - row "Name CPU (%) Network (Mbps) Memory (MB) Disk (MB/s)":
      ...
      - cell "Disk (MB/s)"
  - rowgroup:
    - row "Chrome 7.8% 2.5 Mbps 50.2 MB 0.32 MB/s":
      - cell "Chrome"
      - cell "7.8%"
      - cell "2.5 Mbps"
      - cell "50.2 MB"
      - cell "0.32 MB/s"
    - row "System 7.5% 7.2 Mbps 96.0 MB 0.16 MB/s":
      - cell "System"
      - cell "7.5%"
      - cell "7.2 Mbps"
      - cell "96.0 MB"
      - cell "0.16 MB/s"
    - row "Internet Explorer 1.1% 4.0 Mbps 57.0 MB 0.67 MB/s":
      - cell "Internet Explorer"
      - cell "1.1%"
      - cell "4.0 Mbps"
      - cell "57.0 MB"
      - cell "0.67 MB/s"
    - row "Firefox 3.3% 9.7 Mbps 48.8 MB 0.74 MB/s":
      - cell "Firefox"
      - cell "3.3%"
      - cell "9.7 Mbps"
      - cell "48.8 MB"
...
```ts
  ...
  65 |     for(const ops of opt)
  66 |     {
  67 |         let val = await ops.textContent()
  68 |         if(val.includes('Brazil'))
  69 |         {
  70 |             
> 71 |             await page.selectOption('#country', val);
     |                        ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
  72 |             break;
  73 |         }
  74 |         
