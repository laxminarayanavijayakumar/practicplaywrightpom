...
Call log:
  ...
  - waiting for locator('#demo')
    ...
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\alerts.spec.js:37:41
```
...
- table:
  - rowgroup:
    - row "Name CPU (%) Network (Mbps) Disk (MB/s) Memory (MB)":
      ...
      - cell "Memory (MB)"
  - rowgroup:
    - row "Internet Explorer 2.8% 2.8 Mbps 0.02 MB/s 35.8 MB":
      - cell "Internet Explorer"
      - cell "2.8%"
      - cell "2.8 Mbps"
      - cell "0.02 MB/s"
      - cell "35.8 MB"
    - row "System 9.5% 7.7 Mbps 0.08 MB/s 69.4 MB":
      - cell "System"
      - cell "9.5%"
      - cell "7.7 Mbps"
      - cell "0.08 MB/s"
      - cell "69.4 MB"
    - row "Firefox 6.5% 8.6 Mbps 0.90 MB/s 60.3 MB":
      - cell "Firefox"
      - cell "6.5%"
      - cell "8.6 Mbps"
      - cell "0.90 MB/s"
      - cell "60.3 MB"
    - row "Chrome 7.1% 9.0 Mbps 0.07 MB/s 30.9 MB":
      - cell "Chrome"
      - cell "7.1%"
      - cell "9.0 Mbps"
      - cell "0.07 MB/s"
...
```ts
  ...
  35 |     })
  36 |     await page.click('//button[@onclick="myFunctionConfirm()"]');
> 37 |     await expect(page.locator('#demo')).toHaveText('You pressed OK!');
     |                                         ^ Error: expect(locator).toHaveText(expected)
  38 |
  39 | })
```