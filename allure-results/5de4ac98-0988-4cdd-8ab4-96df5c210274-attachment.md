...
- Location: C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\uploadfiles.spec.js:3:6
...
Call log:
  - waiting for locator('//input[@id="singleFileInput"]')
    - locator resolved to <input type="file" id="singleFileInput"/>

    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\uploadfiles.spec.js:8:58
```
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Memory (MB) CPU (%) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Internet Explorer 0.15 MB/s 84.3 MB 4.3% 7.8 Mbps":
      - cell "Internet Explorer"
      - cell "0.15 MB/s"
      - cell "84.3 MB"
      - cell "4.3%"
      - cell "7.8 Mbps"
    - row "Chrome 0.92 MB/s 98.8 MB 4.2% 1.8 Mbps":
      - cell "Chrome"
      - cell "0.92 MB/s"
      - cell "98.8 MB"
      - cell "4.2%"
      - cell "1.8 Mbps"
    - row "System 0.92 MB/s 95.8 MB 6.1% 6.2 Mbps":
      - cell "System"
      - cell "0.92 MB/s"
      - cell "95.8 MB"
      - cell "6.1%"
      - cell "6.2 Mbps"
    - row "Firefox 0.41 MB/s 84.0 MB 3.3% 9.5 Mbps":
      - cell "Firefox"
      - cell "0.41 MB/s"
      - cell "84.0 MB"
      - cell "3.3%"
...
```ts
   ...
   2 |
   3 | test.only('single file upload', async ({page}) => {
   4 |
   5 |     await page.goto('https://testautomationpractice.blogspot.com/')
   6 |
   7 |     await page.waitForSelector('//input[@id="singleFileInput"]')
>  8 |     await page.locator('//input[@id="singleFileInput"]').check()
     |                                                          ^ Error: locator.check: Error: Not a checkbox or radio button
   9 |
  10 |     await page.locator('#singleFileInput').setInputFiles('tests/uploadfiles/testfile1.pdf')
  11 |
  12 |     // await page.locator('(//button[@type="submit"])[1]').click()
  13 |
  14 |     await page.waitForTimeout(5000);
  15 |     
  16 | })
  17 |
  18 | test('multiple files upload', async ({page}) => {
  19 |
  20 |     await page.goto('')
  21 |     
  22 | })
