...
Received: false
    at C:\Users\HARIKATHIK V\Desktop\sdet-playwright\tests\multiselector.spec.js:22:44
```
...
- table:
  - rowgroup:
    - row "Name Network (Mbps) Disk (MB/s) CPU (%) Memory (MB)":
      - cell "Name"
      - cell "Network (Mbps)"
      - cell "Disk (MB/s)"
      - cell "CPU (%)"
      - cell "Memory (MB)"
  - rowgroup:
    - row "Firefox 1.1 Mbps 0.96 MB/s 4.2% 93.9 MB":
      - cell "Firefox"
      - cell "1.1 Mbps"
      - cell "0.96 MB/s"
      - cell "4.2%"
      - cell "93.9 MB"
    - row "Chrome 6.7 Mbps 0.16 MB/s 3.6% 81.5 MB":
      - cell "Chrome"
      - cell "6.7 Mbps"
      - cell "0.16 MB/s"
      - cell "3.6%"
      - cell "81.5 MB"
    - row "System 3.7 Mbps 0.21 MB/s 8.5% 64.7 MB":
      - cell "System"
      - cell "3.7 Mbps"
      - cell "0.21 MB/s"
      - cell "8.5%"
      - cell "64.7 MB"
    - row "Internet Explorer 0.6 Mbps 0.87 MB/s 2.0% 36.6 MB":
...
```ts
  ...
  18 |     await expect(opts.length).toBe(7);
  19 |
  20 |     // 3) check presence of value in the dropdown
  21 |     const contin  = await page.locator('#colors').textContent()
> 22 |     await expect(contin.includes('Black')).toBeTruthy()
     |                                            ^ Error: expect(received).toBeTruthy()
  23 |
  24 |
